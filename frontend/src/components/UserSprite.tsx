  ...
  return (
    <div className="mt-5 border-2 border-white/20 p-2 w-full">
      ...
      <div className="flex justify-baseline gap-4">
        {friend?.profilePic?(<img src={friend.profilePic as string} className="w-10 h-10 lg:w-15 lg:h-15 rounded-full"></img>):
      ...
      {friend._id&&btnStatus==='red'?(<button onClick={handleUnFollow} className="p-2 bg-red-600 hover:bg-red-500 cursor-pointer rounded">Unfollow</button>)
